...
urlpatterns = [
    ...
    path('Download_data/', views.performance_view, name='performance_view'),
    ...
    path('download-performance-data/', views.download_performance_data, name='download_performance_data'),
